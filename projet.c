...
int main()
{
	...
	system("color 3f");
				...
				printf("\t\t\t\t\t\t|                                                        |\n");
				printf("\t\t\t\t\t\t|       PROMO 20-21, ANNEE UNIVERSITAIRE 2021-2021       |\n");
				printf("\t\t\t\t\t\t|              ________________________                  |\n");
				printf("\t\t\t\t\t\t|                                                        |\n");
				printf("\t\t\t\t\t\t|               Licence 1 Informatique                   |\n");
				printf("\t\t\t\t\t\t|            ALGORITHMIQUE ET PROGRAMMATION 1            |\n");
				printf("\t\t\t\t\t\t|                                                        |\n");
				printf("\t\t\t\t\t\t|                  -----*****-----                       |\n");
				printf("\t\t\t\t\t\t|              CM: Dr KALY - TD: M. DIALLO               |\n");
				printf("\t\t\t\t\t\t|                                                        |\n");
				printf("\t\t\t\t\t\t|              Projet realise par CISSE410               |\n");
				printf("\t\t\t\t\t\t|________________________________________________________|\n");
	printf("\n\t\tDERNIERE COMPILATION DU PROJET LE %s A %s.\n", __DATE__, __TIME__);
	...
	system("pause");
	system("cls");
	printf("\n\t\tNous nous occupons de l'affichage du menu, merci de patienter un peu");
	...
	do
	{
		...
		printf("\n Pour acceder a un exercice, merci de taper sur le numero correspondant du menu: ");
		scanf("%d",&choix);
		system("cls");
		switch(choix)
		{
